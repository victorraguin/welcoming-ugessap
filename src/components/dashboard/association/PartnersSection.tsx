            ...
            <div key={partner.id} className="space-y-4 p-4 border rounded-lg relative">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={partner.name}
                  onChange={(e) => onUpdatePartner(partner.id, "name", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => onUpdatePartner(partner.id, "description", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => onUpdatePartner(partner.id, "logoUrl", e.target.value)}
                />
              </div>
            </div>
          ))}
        </div>
        <Button type="button" onClick={onAddPartner} className="w-full mt-4">
