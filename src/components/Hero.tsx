...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden">
      <div className="absolute inset-0 z-0 bg-gray-900/10">
      ...
      <div className="container mx-auto px-4 pt-20 pb-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 items-start fade-in">
              <Button
                size="lg"
          ...
          <div className="hidden md:block">
            <img
              src="/doctor.jpg"
              alt="Docteur UGESSAP"
              className="rounded-lg shadow-xl w-full max-w-md mx-auto fade-in"
            />
          </div>
        </div>
      </div>
